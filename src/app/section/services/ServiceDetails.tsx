...
const faqData = [
  {
    q: "What is a single property listing?",
  ...
  {
    q: "What information is included in a single property listing?",
    a: "There are many variations of passages the majority have suffered alteration in some fo injected humour, or randomised words believable.",
  },
  {
    q: "Can I add a virtual tour or drone video?",
  ...
  {
    q: "How do I know the property price is fair?",
    a: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less will be distracted by the readable content of a page when looking at its layout.",
  },
];
        ...
        <div className="row">
          ...
          <div className="col-xl-8 col-lg-8">
            <div className="services-details__content">
              ...
              <div className="faq-content mt-25">
