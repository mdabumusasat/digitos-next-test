    ...
    <section className="product-details pt-120">
      ...
      <div className="product-details__buttons">
        <div className="product-details__buttons-1">
          <Link href="/shop-cart" className="theme-btn btn-style-three">Add to Cart</Link>
        </div>
        <div className="product-details__buttons-2">
          <Link href="/shop-product-details" className="theme-btn btn-style-three">Add to Wishlist</Link>
        </div>
      </div>
