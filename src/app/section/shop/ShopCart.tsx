                  ...
                  <table className="table table-striped table-bordered tbl-shopping-cart">
                    ...
                    <tbody>
                      ...
                      <tr className="cart_item">
                        ...
                        <td colSpan={2}>&nbsp;</td>
                        <td>
                      <button type="button" className="theme-btn btn-style-three" data-loading-text="Please wait..."><span className="btn-title">Update Cart</span></button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div className="row">
                  <div className="col-md-5">
                    ...
                    <form className="form" action="/">
                      ...
                      <div className="mb-30">
                        <button type="button" className="theme-btn btn-style-three" data-loading-text="Please wait..."><span className="btn-title">Update Totals</span></button>
                      </div>
                    </form>
                  </div>
                  ...
                  <div className="col-md-5">
                    ...
                    <button type="button" className="theme-btn btn-style-three" data-loading-text="Please wait..."><span className="btn-title">Proceed to Checkout</span></button>
                  </div>
                </div>
              </div>
            </div>
